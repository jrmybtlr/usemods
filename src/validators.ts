...
/**
 * Coerce a value to a {@link Date} when it represents a valid instant; otherwise `null`.
 * @see {@link https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date/Date Date constructor} (MDN)
 */
