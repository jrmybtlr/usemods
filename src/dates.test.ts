...
test('combineDates', () => {
  ...
  expect(mod.combineDates(new Date('2025-01-01T00:00:00Z'), new Date('2025-01-01T08:00:00Z'), { timeZone: 'UTC' })).toBe('January 1, 2025, 12:00 AM - 8:00 AM')
  expect(mod.combineDates(new Date('2025-01-01T00:00:00Z'), new Date('2025-01-01T08:00:00Z'), { locale: 'en-AU', format: 'short', timeZone: 'UTC' })).toBe('1 Jan 2025, 12:00 am - 8:00 am')
  expect(mod.combineDates(new Date('2025-01-01T09:00:00Z'), new Date('2025-01-01T14:30:00Z'), { locale: 'en-AU', format: 'short', timeZone: 'UTC' })).toBe('1 Jan 2025, 9:00 am - 2:30 pm')
