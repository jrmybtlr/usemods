...
test('formatFileSize', () => {
  ...
  expect(mod.formatFileSize(1024, { display: 'short' })).toBe('1 kB')
  expect(mod.formatFileSize(1024, { display: 'long' })).toBe('1 kilobyte')
  expect(mod.formatFileSize(1024, { unitDisplay: 'long' })).toBe('1 kilobyte')
  // Invalid input unit
...
test('formatLength', () => {
  ...
  expect(mod.formatLength(1500, { display: 'short' })).toBe('1.5 m')
  expect(mod.formatLength(1500, { display: 'long' })).toBe('1.5 meters')
  expect(mod.formatLength(1500, { unitDisplay: 'long' })).toBe('1.5 meters')
  // Invalid input unit
