...
### Nuxt Module
Easily integrate into your Nuxt application with auto-imports and reactive composables (`useBreakpoint`, `useScrollPosition`, `useWindowSize`, …) that those Next.js folks can only dream of.
