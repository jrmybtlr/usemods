<template>
  <main class="relative flex max-h-screen min-h-screen flex-col text-clip overflow-hidden">
        ...
        <header class="flex grow flex-col items-center justify-center p-8 md:py-24">
          ...
          <div class="flex flex-col items-center gap-3 pt-12 opacity-50 md:pt-16">
            ...
            <div class="flex items-center gap-3">
              <Icon name="logos:nuxt-icon" class="size-7 grayscale hover:grayscale-0" />
              <Icon name="logos:nextjs-icon" class="size-8 grayscale hover:grayscale-0" />
              <Icon name="logos:vue" class="size-5 grayscale hover:grayscale-0" />
              <Icon name="logos:react" class="size-5 grayscale hover:grayscale-0" />
              <Icon name="logos:svelte-icon" class="size-5 grayscale hover:grayscale-0" />
              <Icon name="logos:solidjs-icon" class="size-5 grayscale hover:grayscale-0" />
              <Icon name="logos:nodejs-icon" class="size-5 grayscale hover:grayscale-0" />
            </div>
          </div>
        </header>
        <section class="shrink">
          <NuxtPicture provider="cloudflare" src="/big-scooter.png" format="webp" alt="A big mods scoooter"
            width="800px" height="510" size="50vw md:800px" densities="1x 2x" :modifiers="{ format: 'auto' }"
    ...
    <div
      class="radial absolute bottom-0 left-1/2 z-0 hidden aspect-square w-full -translate-x-1/2 translate-y-1/2 dark:flex max-lg:hidden" />
  </main>
</template>
...
.radial {
  background: radial-gradient(50% 50% at 50% 50%,
      ...
      rgba(24, 24, 27, 0) 100%);
  background: radial-gradient(50% 50% at 50% 50%,
      color(display-p3 0.165 0.165 0.165) 0%,
      color(display-p3 0.094 0.094 0.106 / 0) 100%);
}
</style>
