<template>
  <DocsLayout>
    <PageTitle>
      <h1>Detections</h1>
      <p>Client-side detections for various user and browser information. Perfect for personalisation, analytics or debugging weird and wonderful bugs. You will need to add listeners for reactivity (or use usemods-nuxt composables).</p>
    </PageTitle>
