<template>
  <DocsLayout>
    <PageTitle>
      <h1>Numbers</h1>
      <p>This file contains functions that are related to numbers.</p>
    </PageTitle>
...
import Median from '~/components/content/numbers/Median.vue'
...
import SubtractMargin from '~/components/content/numbers/SubtractMargin.vue'
