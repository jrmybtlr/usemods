...
bun add usemods"
      ...
      <h2>Next</h2>
      <p>
        If you are using Next.js, you can add the module to your next.config.js
        automagica....just kidding. Next.js doesn't have modules.
        <strong>Live with your choices.</strong>
      </p>

      <h2>Usage</h2>
      <p>
        Once you've installed the package, you can import the functions as you
        need. We'll add better examples in the future, but hopefully your
