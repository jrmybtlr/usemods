<template>
  <div
    ...
    <NuxtLink
      ...
      prefetch
      :to="data?.prev._path"
      class="flex flex-1 flex-col items-start gap-3 rounded-lg border p-5 text-left transition-all dark:hover:bg-white/5"
    ...
    <NuxtLink
      ...
      prefetch
      :to="data?.next._path"
      class="flex flex-1 flex-col items-end gap-3 rounded-lg border p-5 text-right transition-all dark:hover:bg-white/5"
      class:dark="border-white/10">
      <Icon
